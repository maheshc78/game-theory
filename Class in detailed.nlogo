...
to alarm
   output-print("EMERGENCY ALERT")
    wait 0.5
    output-print("EVACUATE")
    wait 10
    output-print("Fight")
...
to setlayout
  ask patches[
    ...
    [
     ...
     ask patches with[pxcor > -10 and pxcor < -6 and pycor > 6 and pycor < 10]
    [
      set pcolor red
    ]
     ask patches with[pxcor > 6 and pxcor < 10 and pycor > 6 and pycor < 10]
    [
      set pcolor red
    ]
    ...
    ask patches with[pxcor > -3 and pxcor < 3 and pycor > -10 and pycor < -7]
    [
      set pcolor black
    ]
    ask patches with[pxcor > 14 and pxcor < 17 and pycor > 5 and pycor < 11]
    [
      set pcolor black
    ]
    create-polices 1[
...
to setstudents
  ...
  ask persons[
    let y random-ycor
    let x random-xcor
    ifelse(y > -8 and y < 3 and x > -8 and x < 8)[
    setxy x y]
    [
    ]
...
to setrun
  ...
  ask persons with[size = 2 and ycor > 8 and ycor < 10]
       [ if( xcor > 14)[die]
       set xcor xcor + 1
       wait 0.2
...
to fight
 ask persons with[pycor < -3]
 [
   if(ycor < -7)[stop]
    set ycor ycor - 1
 ]
 ask persons with[pycor < -3 and pxcor < 0]
       [ if( xcor = 1)[stop]
       set xcor xcor + 1
       wait 0.2
...
Polygon -2674135 true false 195 90 240 150 225 180 165 105
Polygon -2674135 true false 105 90 60 150 75 180 135 105
Rectangle -16777216 false false 225 150 255 165
Rectangle -16777216 true false 225 150 270 165
Rectangle -16777216 true false 225 150 240 180
Rectangle -16777216 true false 225 150 285 165
...
1.0
    org.nlogo.sdm.gui.AggregateDrawing 1
        org.nlogo.sdm.gui.StockFigure "attributes" "attributes" 1 "FillColor" "Color" 225 225 182 176 121 60 40
